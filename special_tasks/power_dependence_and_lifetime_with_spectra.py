...
experiment_label = 'Lifetime_PMMA_film_EuComplex_1mM_740nm_power_dependence'
...
# we use the AOm to modify the power.
V= np.logspace(np.log10(5),np.log10(10),N) # volts to be set

## lifetime parameters
integration_time = 1E-6# secs
duration=0.002   # One run experiment time length
on_time=0.001 # sec
...
adw.go_to_position([aom],[0.01]) # laser off
