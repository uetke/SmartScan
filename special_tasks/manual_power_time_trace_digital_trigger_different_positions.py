# Script for acquiring timetraces vs intensity manually at different points in the sample for each power.
...
X = [center[0]-d,center[0],center[0]+d]
Y = [center[1]-d,center[1],center[1]+d]
Z = 52.12 # um
...
experiment_label = 'PMMA_EuComplex_film_%snm_power_dep_center_%s_%sum'%(W,center[0],center[1])
...
while n <N:
    ...
    if adw.get_digin(0):
        ...
        filename_p = experiment_label +'_Meas_at_'+t+'_TimeTrace_Measured_Power='+str(pw_now)+'uW.dat'
