# Script for measuring the drift. 
# It will follow the position of one single nanorod by refocusing on it several times
# with certain time lapse in between. 
# 
# 
#
######################### M. Caldarola - Aug 2016
# import 
