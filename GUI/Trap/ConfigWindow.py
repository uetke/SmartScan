...
class ConfigWindow(QtGui.QWidget):
    ...
    def __init__(self,parent=None):
        ...
        self.lock_time_label = QtGui.QLabel(self)
        self.lock_time_label.setText('Lock-In Time (s): ')
        self.lock_time = QtGui.QLineEdit(self)
        self.lock_time.setText(str(_session.apdtime))
        self.lock_accuracy_label = QtGui.QLabel(self)
        self.lock_accuracy_label.setText('Lock-In accuracy (ms): ')
        self.lock_accuracy = QtGui.QLineEdit(self)
        self.lock_accuracy.setText(str(_session.lockInAcc*1000))
        ...
        self.layout.addWidget(self.lock_time_label,4,0)
        self.layout.addWidget(self.lock_time,4,1)
        self.layout.addWidget(self.lock_accuracy_label,5,0)
        self.layout.addWidget(self.lock_accuracy,5,1)
        self.layout.addWidget(self.monitor_save_label,6,0)
        self.layout.addWidget(self.monitor_save,6,1)
        self.layout.addWidget(self.monitor_timeresol_label,7,0)
        self.layout.addWidget(self.monitor_timeresol,7,1)
        self.layout.addWidget(self.contin_runs,8,0)
    ...
    def SetTimes(self):
        ...
        new_lock_time = float(self.lock_time.text())
        new_lock_accuracy = float(self.lock_accuracy.text())/1000
        ...
        _session.lockInTime = new_lock_time
        _session.lockInAcc = new_lock_accuracy
